...
func localisedTitle(tr *i18n.TranslationSet, str string) string {
	contextTitleMap := map[string]string{
		...
		"prReview":          tr.PrReviewTitle,
		"prReviewDiff":      tr.PrReviewTitle,
		"prList":            tr.PrListTitle,
		"prOverview":        tr.PrOverviewTitle,
		"prConversation":    tr.PrReviewConversationTitle,
		"prChecks":          tr.PrChecksTitle,
		"prCommits":         tr.PrCommitsTitle,
